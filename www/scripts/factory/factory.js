    ...
    return {
      ...
      initToggles: function()
      {
        ...
        $rootScope.settingsPaneToggle = function()
        {
          ...
          if(public_vars.$body.hasClass('settings-pane-open')) // DO I NEED?
          {
          ...
          TweenMax.to(scroll, (use_animation ? .1 : 0), {top: scroll.toTop, roundProps: ['top'], ease: scroll.toTop < 10 ? null : Sine.easeOut, onUpdate: function()
          {
            ...
            onComplete: function()
            {
              if(use_animation)
              {
                ...
                {
                  public_vars.$body.addClass('settings-pane-open'); // DO I NEED?
                ...
                else
                {
                  ...
                  {
                    public_vars.$body.removeClass('settings-pane-open'); // DO I NEED?
                    public_vars.$settingsPane.css({height: ''});
              ...
              {
                // Without Animation
                public_vars.$body.toggleClass('settings-pane-open'); // DO I NEED?
