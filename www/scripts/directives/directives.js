angular.module('app.directives', []).
  ...
  directive('bbNavbar', function(){
    return {
      restrict: 'E',
      templateUrl: appHelper.templatePath('admin/navbar'),
  ...
  directive('horizontalMenu', function(){
    return {
      restrict: 'E',
      replace: true,
      templateUrl: appHelper.templatePath('admin/horizontal-menu'),
  ...
  directive('sidebarMenu', function(){
    return {
      restrict: 'E',
      templateUrl: appHelper.templatePath('admin/sidebar-menu'),
  ...
  directive('sidebarChat', function(){
    return {
      restrict: 'E',
      replace: true,
      templateUrl: appHelper.templatePath('admin/sidebar-chat')
    };
  }).
  directive('footerChat', function(){
    return {
      ...
      templateUrl: appHelper.templatePath('admin/footer-chat')
    };
  }).
  directive('sidebarLogo', function(){
    return {
      restrict: 'E',
      replace: true,
      templateUrl: appHelper.templatePath('admin/sidebar-logo')
    };
  }).
  /*directive('sidebarProfile', function(){
    return {
      restrict: 'E',
      replace: true,
      templateUrl: appHelper.templatePath('admin/sidebar-profile')
    };
  }). */
  directive('userInfoNavbar', function(){
    return {
      restrict: 'E',
      replace: true,
      templateUrl: appHelper.templatePath('admin/user-info-navbar')
    };
  }).
  directive('pageTitle', function(){
    return {
      restrict: 'E',
      replace: true,
      templateUrl: appHelper.templatePath('admin/page-title'),
  ...
  directive('siteFooter', function(){
    return {
      restrict: 'E',
      templateUrl: appHelper.templatePath('admin/footer')
    };
  }).
